# Translation Verification Experiment: claude to agents
...
| `subagent` | `.claude/agents/{name}/agent.md` | `agents/{name}/agent.md` | Frontmatter preserved; layout moved from `.claude/agents/` to `agents/` | PASS |
...
2. Subagent directories moved from `.claude/agents/` to `agents/`.
